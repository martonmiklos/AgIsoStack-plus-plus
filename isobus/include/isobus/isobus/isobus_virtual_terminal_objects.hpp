...
namespace isobus
{
	...
	class VariableReferenceableVTObject : public VTObject
	{
	public:
	...
	class TextualVTObject : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	protected:
		...
		std::uint8_t options = 0; ///< Bitfield of options defined in `Options` enum
	};

	/// @brief The Input Boolean object is used to input a TRUE/FALSE type indication from the operator
	class InputBoolean : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class InputString : public TextualVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class NumericVTobject : public TextualVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class InputNumber : public NumericVTobject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class InputList : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputString : public TextualVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputNumber : public NumericVTobject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputList : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputMeter : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputLinearBarGraph : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
	...
	class OutputArchedBarGraph : public VariableReferenceableVTObject
	{
	public:
		/// @brief Enumerates this object's attributes which are assigned an attribute ID.
		/// The Change Attribute command allows any writable attribute with an AID to be changed.
